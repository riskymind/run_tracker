package com.asterisk.runtracker.services
...
import com.asterisk.runtracker.utils.Constants.FASTEST_LOCATION_INTERVAL
import com.asterisk.runtracker.utils.Constants.LOCATION_UPDATE_INTERVAL
import com.asterisk.runtracker.utils.Constants.NOTIFICATION_CHANNEL_ID
import com.asterisk.runtracker.utils.Constants.NOTIFICATION_CHANNEL_NAME
import com.asterisk.runtracker.utils.Constants.NOTIFICATION_ID
import com.asterisk.runtracker.utils.Constants.TIMER_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
        ...
        intent?.let {
            when (it.action) {
                ACTION_START_OR_RESUME_SERVICE -> {
                    Timber.d("Service started or removed")
                    if (isFirstRun) {
    ...
    private fun getMainPendingIntent() = PendingIntent.getActivity(
        this, 0,
